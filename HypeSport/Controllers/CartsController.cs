...
namespace HypeSport.Controllers
{
    public class CartsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,IsDeleted")] Cart cart)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,IsDeleted")] Cart cart)
        {
            if (id != cart.Id)
            {
                return NotFound();
